    ...
    <div className="topbar py-2 px-4 text-xs text-gray-300">
      <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-2">
        <div className="flex flex-wrap items-center gap-x-4 gap-y-2 min-w-0">
          ...
          <a href="mailto:contact@onlinereputationbuilders.in" onClick={trackEmailClick} className="flex items-center gap-1.5 hover:text-yellow-400 transition-colors break-all">
            <svg className="w-3.5 h-3.5" width="14" height="14" fill="currentColor" viewBox="0 0 20 20">
              <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"/>
              <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"/>
            </svg>
            contact@onlinereputationbuilders.in
          </a>
