    ...
    <div className="topbar py-2 px-4 text-xs text-gray-300">
      <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-2">
        <div className="flex flex-wrap items-center gap-x-4 gap-y-2 min-w-0">
          <a href="tel:+918882788412" className="flex items-center gap-1.5 hover:text-yellow-400 transition-colors">
            <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
              <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"/>
            </svg>
            Call: +9188827 88412
          </a>
          <a href="mailto:contact@onlinereputationbuilder.in" className="flex items-center gap-1.5 hover:text-yellow-400 transition-colors break-all">
            <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="flex items-center gap-4">
          {[
            ...
            <a key={s.icon} href={s.href} target="_blank" rel="noopener noreferrer" className="hover:text-yellow-400 transition-colors">
              ...
              {s.icon === "instagram" && <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37z" fill="#0d1f3c"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5" stroke="#0d1f3c" strokeWidth="2"/></svg>}
            </a>
          ))}
        </div>
      </div>
