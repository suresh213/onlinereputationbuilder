...
// // // //                 <Link
// // // //                   href={item.href}
// // // //                   className="block py-3 text-xs font-bold text-brand-blue uppercase tracking-wider border-b border-zinc-100"
...
// // // //                       key={c.label}
// // // //                       href={c.href}
// // // //                       className="block py-2 px-2 text-sm text-gray-600 hover:text-brand-blue rounded-sm hover:bg-white transition-colors"
// // // //                       onClick={() => setMobileOpen(false)}
// // // //                     >
// // // //                       {c.label}
// // // //                     </Link>
...
// // // //             </div>
// // // //           ))}
// // // //           <a href="tel:+918882788412" className="btn-gold w-full text-center mt-4 block">
// // // //             Call: +9188827 88412
// // // //           </a>
// // // //         </div>
// // // //       )}
...
// // //     isMegaMenu: true,
// // //     // Mega menu desktop structure
// // //     columns: [
// // //       {
// // //         title: "Content Removal",
// // //         bgColor: "bg-brand-blue/5", // Replaced peach with brand-blue soft tint
// // //         links: [
// // //           { label: "Quora Content Removal", href: "/review-management/quora-content-removal" },
// // //           { label: "Reddit Post Removal", href: "/review-management/reddit-post-removal" },
// // //           { label: "Fake News Removal", href: "/review-management/fake-news-removal" },
...
// // //   // Add subtle shadow and background blur when scrolling down
// // //   useEffect(() => {
// // //     const handleScroll = () => {
...
// // //           <div className="w-10 h-10 rounded-xl bg-brand-blue flex items-center justify-center flex-shrink-0 group-hover:bg-[#1a4a9c] group-hover:shadow-lg group-hover:shadow-brand-blue/30 transition-all duration-300">
// // //             <svg className="w-5 h-5 text-brand-gold-light group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
// // //               <path d="M12 1.5L3 6.75V12c0 5.25 3.92 10.12 9 11.25C17.08 22.12 21 17.25 21 12V6.75L12 1.5z"/>
// // //             </svg>
// // //           </div>
// // //           <div className="leading-tight">
...
// // //                       {col.hasButton && (
// // //                         <div className="mt-10">
// // //                           <Link href="/review-management/video-and-image" className="inline-flex items-center justify-center px-7 py-3 bg-brand-blue text-white font-bold text-sm rounded-full hover:bg-brand-dark transition-all shadow-[0_8px_20px_rgba(37,99,235,0.2)] hover:shadow-[0_10px_25px_rgba(37,99,235,0.3)] hover:-translate-y-0.5">
// // //                             Know More
// // //                           </Link>
// // //                         </div>
// // //                       )}
...
// // //           <button
// // //             className="xl:hidden w-10 h-10 flex items-center justify-center rounded-xl bg-zinc-100 hover:bg-zinc-200 transition-colors"
// // //             onClick={() => setMobileOpen(!mobileOpen)}
// // //             aria-label="Toggle menu"
// // //           >
// // //             {mobileOpen ? (
...
// // //       {/* Mobile Menu */}
// // //       <div 
// // //         className={`xl:hidden absolute top-full left-0 w-full bg-white border-b border-zinc-200 shadow-2xl transition-all duration-300 origin-top overflow-hidden ${
...
// // //                 <div>
// // //                   <button
// // //                     className="w-full text-left py-4 text-[0.8rem] font-bold text-zinc-900 uppercase tracking-widest flex items-center justify-between"
// // //                     onClick={() => setOpenDrop(openDrop === item.label ? null : item.label)}
// // //                   >
// // //                     {item.label}
...
//         {/* Desktop Nav - Restored to lg:flex for correct visibility */}
...
//         {/* Action Button & Hamburger Wrapper */}
//         <div className="flex items-center gap-4 relative z-20">
//           {/* Restored to lg:inline-flex so it doesn't hide on laptop screens */}
//           <a
//             href="tel:+918882788412"
...
//           {/* Restored to lg:hidden to show hamburger menu at the correct breakpoint */}
//           <button
...
//       {/* Mobile Menu - Restored to lg:hidden */}
//       <div 
