    ...
    <footer className="footer-bg text-gray-300">
      ...
      <div className="bg-brand-blue py-6 px-4">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <a href="tel:+919971687251" className="btn-gold whitespace-nowrap flex-shrink-0">
            Call: +91 99716 87251
          </a>
        </div>
      </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <a href="tel:+919971687251" className="text-white font-semibold hover:text-brand-gold-light transition-colors text-sm">+91 99716-87251</a>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <svg className="w-4 h-4 text-brand-gold mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
