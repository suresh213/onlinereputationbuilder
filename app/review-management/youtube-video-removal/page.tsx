...
const impacts = [
  { label: "Negative videos rank high in Google search results", icon: "🔍" },
  { label: "Harmful content erodes customer and investor trust", icon: "📉" },
  { label: "Damaging videos can go viral and spread unchecked", icon: "🎬" },
  { label: "Competitors exploit weakened YouTube reputation", icon: "⚔️" },
];
...
const importanceReasons = [
  {
    ...
    desc: "Negative YouTube videos can rank prominently in Google search results for your name or brand, meaning they are often one of the first things potential clients, employers, or partners see. Removal directly improves your search presence.",
    icon: (
  ...
  {
    step: "02",
    title: "Prevent Business & Revenue Losses",
    desc: "A single damaging YouTube video can deter potential customers, scare away investors, and weaken partner relationships. The financial consequences of unaddressed negative video content compound over time as views accumulate.",
    icon: (
      <svg width="24" height="24" className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    step: "04",
    title: "Control Your Brand Narrative",
    desc: "Removing damaging YouTube content restores your ability to control what audiences see and experience about your brand. With clean search results and a positive YouTube presence, you can build genuine credibility with your target audience.",
    icon: (
      <svg width="24" height="24" className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const expertProcess = [
  { title: "Video & Channel Audit", desc: "We identify all harmful videos targeting your brand across YouTube, assessing view counts, search rankings, comment sections, and the grounds available for removal." },
  { title: "YouTube Policy Filing", desc: "Our team prepares and submits precise removal requests citing specific YouTube community guidelines, copyright policies, or terms of service violations to maximise approval rates." },
  { title: "DMCA & Legal Escalation", desc: "For copyright-infringing content, we file DMCA takedowns. For defamatory videos, our legal partners issue formal cease-and-desist letters and court-ordered removal requests." },
  { title: "Search Suppression", desc: "For videos resistant to direct removal, we deploy advanced SEO strategies to suppress negative YouTube content in Google and YouTube search results, replacing it with positive material." },
  { title: "Continuous Monitoring", desc: "We monitor YouTube and Google search for re-uploads or new harmful videos targeting your brand, alerting you immediately so each threat is contained before it gains traction." },
];
...
export default function YouTubeRemovalPage() {
  return (
          ...
          <div className="hero-copy mt-4">
            <RevealOnScroll>
              <div className="hero-badge inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-[0.67rem] font-bold mb-6 uppercase tracking-[0.15em] border-brand-gold/30 bg-brand-gold/10 text-brand-gold shadow-[0_0_15px_rgba(194,148,10,0.15)]">
                ...
                YouTube Video Removal · 12+ Years Experience
              </div>
              ...
              <ul className="space-y-3 mb-10 max-w-xl">
                {[
                  "Swiftly address negative videos affecting your reputation",
                  "Expertise in handling complex removal cases with precision",
                  "Comprehensive support for all types of video takedowns",
                  "Ensure long-term brand protection from damaging content",
                ].map((item) => (
              ...
              <div className="glass-panel border-l-4 border-l-red-600 bg-white/5 rounded-r-xl p-4 md:p-5 backdrop-blur-sm relative overflow-hidden">
          ...
          <div className="relative lg:mt-6 h-full w-full min-h-[500px]">
            <RevealOnScroll delay={200} className="h-full">
              <div className="absolute inset-0 rounded-3xl overflow-hidden shadow-2xl border border-zinc-700/50">
                <img src="https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?auto=format&fit=crop&w=1200&q=80" alt="YouTube Video Removal Service" className="w-full h-full object-cover opacity-40" />
              ...
              <div className="relative glass-panel bg-zinc-950/60 backdrop-blur-xl border border-white/10 rounded-3xl p-8 lg:p-10 shadow-2xl m-4 mt-12 sm:m-8 lg:m-6 h-[calc(100%-3rem)]">
                <div className="flex items-center justify-between mb-6 border-b border-zinc-800/80 pb-5 relative z-10">
                  ...
                  <div className="w-12 h-12 rounded-xl bg-red-600/10 border border-red-600/20 flex items-center justify-center flex-shrink-0 text-xl">🎬</div>
                </div>
                <ContactForm dark />
              </div>
            </RevealOnScroll>
            ...
            <RevealOnScroll>
              <div className="premium-copy-panel pr-0 lg:pr-8">
                ...
                <h2 className="font-heading text-3xl lg:text-[2.5rem] font-bold text-zinc-900 mb-6 leading-tight">
                  Why Negative YouTube Videos Are <span className="heading-script text-brand-blue">So Damaging</span>
                </h2>
                <p className="text-zinc-600 leading-relaxed mb-5 text-[0.95rem]">
                  Negative YouTube videos can cause significant harm to your personal or brand image, leading to trust issues and potential loss of business. Taking immediate action to remove damaging content helps preserve your credibility and online presence.
                </p>
                <p className="text-zinc-500 leading-relaxed mb-8 text-[0.95rem]">
                  YouTube is the world's second largest search engine, and negative videos about your brand often appear prominently in Google results. Without professional help, navigating YouTube's complex removal process is challenging and time-consuming.
                </p>
            ...
            <RevealOnScroll delay={200}>
              <div className="relative w-full max-w-lg mx-auto lg:ml-auto">
                ...
                <div className="premium-image-frame rounded-3xl overflow-hidden shadow-2xl border border-zinc-200/50 relative z-10">
                  {/* <img src="https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?auto=format&fit=crop&w=800&q=80" alt="YouTube Video Removal Impact" className="w-full h-auto object-cover aspect-[4/5] hover:scale-105 transition-transform duration-700" /> */}
                  <img src="https://images.unsplash.com/photo-1611162616475-46b635cb6868?auto=format&fit=crop&w=800&q=80" alt="YouTube Video Removal Impact" className="w-full h-auto object-cover aspect-[4/5] hover:scale-105 transition-transform duration-700" />
                </div>
                <div className="absolute -bottom-6 -right-6 z-20 glass-panel-light p-4 rounded-2xl border border-white shadow-xl hidden md:flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm font-bold text-zinc-900 mb-0.5">Video Removed</p>
          ...
          <RevealOnScroll>
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <h2 className="font-heading text-3xl lg:text-4xl font-bold text-zinc-900 leading-tight">
                Importance of Removing <span className="heading-script text-brand-blue">Negative YouTube Videos</span>
              </h2>
              <p className="text-zinc-500 text-[0.95rem] mt-5 max-w-xl mx-auto leading-relaxed">
                Taking immediate action to remove harmful YouTube videos is essential to protecting your credibility, search results, and long-term business reputation.
              </p>
            </div>
          </RevealOnScroll>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-16 items-center">
          <div className="relative order-2 lg:order-1">
            <RevealOnScroll>
              ...
              <div className="premium-image-frame rounded-3xl overflow-hidden shadow-[0_20px_50px_-15px_rgba(0,0,0,0.2)] border border-zinc-200">
                <img src="https://images.unsplash.com/photo-1563986768609-322da13575f3?auto=format&fit=crop&w=800&q=80" alt="YouTube Removal Expert Process" className="w-full h-auto object-cover aspect-square" />
              </div>
            </RevealOnScroll>
          </div>
          <div className="premium-copy-panel order-1 lg:order-2 pl-0 lg:pl-8">
            <RevealOnScroll>
              ...
              <h2 className="font-heading text-3xl lg:text-[2.5rem] font-bold text-zinc-900 mb-6 leading-tight">
                How Our Experts Handle <span className="heading-script text-brand-blue">YouTube Video Removal</span>
              </h2>
              <p className="text-zinc-500 leading-relaxed mb-10 text-[0.95rem]">
                Our specialists use a proven, multi-layered approach to remove or suppress harmful YouTube videos quickly and effectively. We handle the entire process so you can focus on rebuilding your reputation.
              </p>
            </RevealOnScroll>
      ...
      <RevealOnScroll>
        <div className="sticky top-24">
          ...
          <p className="text-zinc-500 text-[0.95rem] leading-relaxed mb-8">
            Have a specific YouTube case? Our experts offer a free assessment and a clear removal plan.
          </p>
          ...
          <RevealOnScroll>
            <div className="premium-copy-panel-dark">
              ...
              <h2 className="font-heading text-3xl lg:text-[2.75rem] font-bold text-white mb-6 leading-tight tracking-tight">
                Don&apos;t Let YouTube Videos <span className="heading-script text-blue-400">Define Your Brand</span>
              </h2>
              <p className="text-zinc-400 leading-relaxed mb-10 text-[0.95rem] max-w-lg">
                Schedule a free consultation. Every day a negative YouTube video remains live, it accumulates views and ranks in search results. Our experts will assess your situation and act fast.
              </p>
