...
const impacts = [
  { label: "Viral harmful videos can damage your brand in hours", icon: "🎵" },
  { label: "Negative TikTok content affects your search rankings", icon: "📉" },
  { label: "Your audience and followers lose trust in your brand", icon: "💔" },
  { label: "Competitors exploit your weakened TikTok reputation", icon: "⚔️" },
];
...
const importanceReasons = [
  {
    ...
    desc: "Harmful TikTok videos and posts can spread virally within minutes, damaging your personal or business credibility. If left unchecked, negative TikTok content erodes trust with your audience, potential clients, and partners.",
    icon: (
  ...
  {
    step: "02",
    title: "Stop Viral Spread Fast",
    desc: "TikTok's algorithm can push negative content to millions of viewers rapidly. Early removal prevents the snowball effect where damaging videos keep accumulating views and comments, making the problem progressively harder to contain.",
    icon: (
      <svg width="24" height="24" className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    step: "04",
    title: "Reclaim Your TikTok Narrative",
    desc: "By removing or suppressing damaging content, you regain control over your TikTok presence. With a clean, positive profile, you can rebuild audience trust and ensure your brand's true story is what people see.",
    icon: (
      <svg width="24" height="24" className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const expertProcess = [
  { title: "Content Identification", desc: "We audit your TikTok profile and identify harmful videos, posts, duets, or comments that are damaging your reputation and need to be actioned." },
  { title: "Platform Policy Filing", desc: "Our team files precise takedown requests with TikTok, citing specific community guidelines and policies to maximise the likelihood of swift removal." },
  { title: "Advanced Suppression", desc: "For content that resists removal, we deploy advanced SEO and content strategies to suppress negative TikTok videos in search results and platform recommendations." },
  { title: "Legal Escalation", desc: "Our legal partners assist with DMCA notices, defamation claims, and court-ordered removal requests when platform-level removal is insufficient." },
  { title: "Ongoing Brand Monitoring", desc: "We continuously monitor TikTok for re-uploads or new harmful content and alert you immediately so threats are addressed before they escalate." },
];
...
export default function TikTokRemovalPage() {
  return (
          ...
          <div className="hero-copy mt-4">
            <RevealOnScroll>
              <div className="hero-badge inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-[0.67rem] font-bold mb-6 uppercase tracking-[0.15em] border-brand-gold/30 bg-brand-gold/10 text-brand-gold shadow-[0_0_15px_rgba(194,148,10,0.15)]">
                ...
                TikTok Content Removal · 12+ Years Experience
              </div>
              ...
              <ul className="space-y-3 mb-10 max-w-xl">
                {[
                  "Quickly remove harmful or inappropriate content from TikTok",
                  "Safeguard your brand image by eliminating negative or damaging posts",
                  "Strengthen audience trust through consistent reputation management",
                  "Professional assistance managing your TikTok presence effectively",
                ].map((item) => (
              ...
              <div className="glass-panel border-l-4 border-l-[#ff0050] bg-white/5 rounded-r-xl p-4 md:p-5 backdrop-blur-sm relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-[#ff0050]/10 to-transparent pointer-events-none" />
          ...
          <div className="relative lg:mt-6 h-full w-full min-h-[500px]">
            <RevealOnScroll delay={200} className="h-full">
              <div className="absolute inset-0 rounded-3xl overflow-hidden shadow-2xl border border-zinc-700/50">
                <img src="https://images.unsplash.com/photo-1611162616305-c69b3fa7fbe0?auto=format&fit=crop&w=1200&q=80" alt="TikTok Reputation Management" className="w-full h-full object-cover opacity-40" />
              ...
              <div className="relative glass-panel bg-zinc-950/60 backdrop-blur-xl border border-white/10 rounded-3xl p-8 lg:p-10 shadow-2xl m-4 mt-12 sm:m-8 lg:m-6 h-[calc(100%-3rem)]">
                <div className="flex items-center justify-between mb-6 border-b border-zinc-800/80 pb-5 relative z-10">
                  ...
                  <div className="w-12 h-12 rounded-xl bg-[#ff0050]/10 border border-[#ff0050]/20 flex items-center justify-center flex-shrink-0 text-xl">🎵</div>
                </div>
                <ContactForm dark />
              </div>
            </RevealOnScroll>
            ...
            <RevealOnScroll>
              <div className="premium-copy-panel pr-0 lg:pr-8">
                ...
                <h2 className="font-heading text-3xl lg:text-[2.5rem] font-bold text-zinc-900 mb-6 leading-tight">
                  Why Harmful TikTok Content Is <span className="heading-script text-brand-blue">So Dangerous</span>
                </h2>
                <p className="text-zinc-600 leading-relaxed mb-5 text-[0.95rem]">
                  TikTok's powerful recommendation algorithm means a single harmful video can reach millions of viewers who have no prior connection to you or your brand. Unlike other platforms, negative TikTok content can achieve viral reach within hours, making rapid response essential.
                </p>
                <p className="text-zinc-500 leading-relaxed mb-8 text-[0.95rem]">
                  TikTok's content policies are complex, and navigating removal requests without professional expertise often leads to rejections. Without proper documentation and platform knowledge, harmful content can remain live indefinitely, continuing to damage your reputation.
                </p>
          ...
          <RevealOnScroll>
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <h2 className="font-heading text-3xl lg:text-4xl font-bold text-zinc-900 leading-tight">
                Importance of Removing <span className="heading-script text-brand-blue">Harmful TikTok Content</span>
              </h2>
              <p className="text-zinc-500 text-[0.95rem] mt-5 max-w-xl mx-auto leading-relaxed">
                Removing damaging TikTok videos and posts is essential to protect your reputation, maintain audience trust, and prevent the algorithmic amplification of harmful content across the platform.
              </p>
            </div>
          </RevealOnScroll>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-16 items-center">
          <div className="relative order-2 lg:order-1">
            <RevealOnScroll>
              ...
              <div className="premium-image-frame rounded-3xl overflow-hidden shadow-[0_20px_50px_-15px_rgba(0,0,0,0.2)] border border-zinc-200">
                <img src="https://images.unsplash.com/photo-1563986768609-322da13575f3?auto=format&fit=crop&w=800&q=80" alt="TikTok Removal Expert Process" className="w-full h-auto object-cover aspect-square" />
              </div>
            </RevealOnScroll>
          </div>
          <div className="premium-copy-panel order-1 lg:order-2 pl-0 lg:pl-8">
            <RevealOnScroll>
              ...
              <h2 className="font-heading text-3xl lg:text-[2.5rem] font-bold text-zinc-900 mb-6 leading-tight">
                How Our Experts Handle <span className="heading-script text-brand-blue">TikTok Content Removal</span>
              </h2>
              <p className="text-zinc-500 leading-relaxed mb-10 text-[0.95rem]">
                Our specialists follow a proven, comprehensive process to remove or suppress harmful TikTok content quickly and effectively. We handle every step so you can focus on your brand.
              </p>
            </RevealOnScroll>
      ...
      <RevealOnScroll>
        <div className="sticky top-24">
          ...
          <p className="text-zinc-500 text-[0.95rem] leading-relaxed mb-8">
            Have a specific TikTok case? Our experts offer a free assessment and present a clear removal plan.
          </p>
          ...
          <RevealOnScroll>
            <div className="premium-copy-panel-dark">
              ...
              <h2 className="font-heading text-3xl lg:text-[2.75rem] font-bold text-white mb-6 leading-tight tracking-tight">
                Don&apos;t Let TikTok Content <span className="heading-script text-blue-400">Destroy Your Reputation</span>
              </h2>
              <p className="text-zinc-400 leading-relaxed mb-10 text-[0.95rem] max-w-lg">
                Schedule a free consultation. Every hour harmful TikTok content stays live, it risks going viral and causing permanent damage. Our experts will assess your situation and act fast.
              </p>
