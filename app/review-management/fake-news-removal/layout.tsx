...
export const metadata: Metadata = {
  ...
  description: "Eliminate fake news posts, online defamation, and unverified allegations from search indexes. Take down illegal media publications quickly with DMCA and legal tools.",
