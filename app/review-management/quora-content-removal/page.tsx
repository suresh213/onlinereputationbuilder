...
//               Remove Negative{" "}
//               <span className="text-brand-gold-light">Quora Content</span>{" "}
...
//                   <span className="text-red-500 font-black text-lg">Q</span>
//                 </div>
//               </div>
//               <ContactForm />
//             </div>
...
//                 Why Quora Content Matters For Your Business Reputation
//               </h2>
...
//                 {profileImportance.map((item) => (
//                   <div key={item.title} className="group flex items-start gap-4 p-4 rounded-xl border border-zinc-200 hover:border-brand-blue/20 hover:bg-blue-50/20 transition-all">
//                     <div className="w-9 h-9 rounded-lg bg-zinc-50 border border-zinc-100 flex items-center justify-center text-zinc-400 group-hover:bg-brand-blue group-hover:text-white group-hover:border-brand-blue transition-all flex-shrink-0">{item.icon}</div>
//                     <div>
//                       <h4 className="font-bold text-zinc-900 text-sm mb-1 group-hover:text-brand-blue transition-colors">{item.title}</h4>
...
//                 <img src="https://images.unsplash.com/photo-1562577309-4932fdd64cd1?auto=format&fit=crop&w=800&q=80" alt="Managing Your Quora Profile" />
//               </div>
...
//             <p className="section-label mb-3 justify-center">Our Methods</p>
//             <h2 className="font-heading text-3xl font-bold text-zinc-900 leading-tight">
//               How Our Experts Manage Your Quora Account
//             </h2>
...
//               <div key={m.step} className="group border border-zinc-200 rounded-xl p-6 bg-white hover:border-brand-blue/20 hover:shadow-[0_8px_32px_rgba(37,99,235,0.08)] transition-all duration-300 relative overflow-hidden">
...
//                   <div className="w-11 h-11 rounded-lg bg-zinc-50 border border-zinc-100 flex items-center justify-center text-zinc-400 group-hover:bg-blue-50 group-hover:text-brand-blue group-hover:border-blue-100 transition-all">{m.icon}</div>
...
//       {/* ── DELETE NEGATIVE HISTORY ──────────────────────────── */}
//       <section className="py-20 px-4 bg-white border-b border-zinc-100 overflow-hidden">
//         <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
//           <div className="relative">
//             <div className="img-frame">
//               <img src="https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?auto=format&fit=crop&w=800&q=80" alt="Delete Negative Quora History" />
//             </div>
//           </div>
//           <div>
//             <p className="section-label mb-3">Suppression & Removal</p>
//             <h2 className="font-heading text-3xl font-bold text-zinc-900 mb-5 leading-tight heading-underline">
//               Delete Your Negative Quora History with Reputation Management Experts
//             </h2>
...
//               ))}
//             </div>
//             <Link href="#contact" className="btn-gold">Start Removal Process</Link>
//           </div>
//         </div>
//       </section>
