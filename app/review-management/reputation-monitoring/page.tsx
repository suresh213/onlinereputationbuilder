...
// const stats = [
//   { number: "24/7", label: "Real-Time Scan Operations" },
//   { number: "1M+", label: "Web Data Points Monitored Daily" },
//   { number: "99.4%", label: "Crisis Vector Alert Accuracy" },
//   { number: "1200+", label: "Corporate Brands Active" },
// ];

// const monitorHighlights = [
//   {
//     title: "Continuous Sentiment Auditing",
//     desc: "Our systems scour Google Search result changes, active blogs, news portals, and subreddit forums to catch negative shifts before they gain public scale.",
//   },
//   {
//     title: "Instant Threat Alerts",
//     desc: "Receive real-time dashboard triggers when flagged keywords, employee leaks, or malicious consumer forum threads mention your private or corporate name.",
//   },
//   {
//     title: "Competitive Analysis Streams",
//     desc: "We track brand sentiment fluctuations relative to top industry rivals, giving your PR operations deep insights to pivot strategy proactively.",
//   },
// ];

// const technicalWorkflow = [
//   { step: "01", title: "Target Footprint Mapping", desc: "We map your brand keywords, operational names, and executive profiles across public databases and social data nodes." },
//   { step: "02", title: "Real-Time Scraper Setup", desc: "We connect specialized crawling scripts that log changes across index files, forum boards, and mainstream news rooms instantly." },
//   { step: "03", title: "Data Sentiment Filtering", desc: "Our filters process incoming text variations to separate normal user noise from targeted attack drops or algorithmic risk flags." },
//   { step: "04", title: "Action Plan Deployment", desc: "When critical data alerts flash, our ORM team steps in instantly to execute removals, suppression loops, or platform appeals cleanly." },
// ];

// const faqs = [
//   { q: "What data channels do your scrapers monitor?", a: "We monitor global search engines, news outlets, major consumer review sites, glassdoor portals, public forums, and localized digital discussion boards constantly." },
//   { q: "How quickly do alert triggers reach our team?", a: "Most digital web monitoring loops sync in real-time. If a new indexed threat matches your private keyword profiles, notification loops trigger instantly." },
//   { q: "Can we track personal names as well as company brands?", a: "Yes. Our systems handle high-visibility private figures, corporate entities, brand keywords, and proprietary catalog terms seamlessly." },
// ];
...
//                 Real-Time Sentinel Network
//               </div>
//               <h1 className="font-heading text-4xl sm:text-5xl lg:text-[3.5rem] font-black text-white leading-[1.08] mb-6 tracking-tight">
//                 24/7 Digital <span className="text-gradient-gold">Reputation Monitoring</span> &amp; Threat Detection
//               </h1>
//               <p className="text-white/70 text-base lg:text-lg mb-8 leading-relaxed max-w-2xl">
//                 Negative articles and targeted review attacks spread rapidly. Our advanced data scanning architecture continuously tracks web changes to stop reputational damage at the absolute source.
//               </p>
//               <div className="flex flex-wrap gap-4">
//                 <Link href="#contact" className="btn-gold shadow-lg shadow-brand-gold/20 px-8 py-3.5">Activate Data Sentinel Stream</Link>
...
//                 <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1200&q=80" alt="Data Network Controls Dashboard" className="w-full h-full object-cover opacity-30 mix-blend-luminosity" />
...
//                   <div>
//                     <p className="section-label text-brand-gold mb-1">Network Access</p>
//                     <h2 className="font-heading text-xl font-bold text-white leading-tight">Request Sentinel Setup</h2>
//                   </div>
//                 </div>
//                 <ContactForm dark />
//               </div>
...
//             <RevealOnScroll>
//               <div>
//                 <p className="section-label mb-2 text-brand-gold">Preemptive Security</p>
//                 <h2 className="font-heading text-3xl lg:text-[2.5rem] font-bold text-zinc-900 mb-6 leading-tight">Why Early Threat Tracking Controls Public <span className="heading-script text-brand-blue">Brand Values</span></h2>
//                 <p className="text-zinc-500 leading-relaxed mb-8 text-[0.95rem]">Waiting until negative content ranks page-one compounds cleanup costs heavily. Our automated scanning captures threat vectors cleanly at creation maps.</p>
//               </div>
//             </RevealOnScroll>
...
//               <h2 className="font-heading text-3xl lg:text-4xl font-bold text-zinc-900 leading-tight">Technical Data <span className="heading-script text-brand-blue">Tracking Architecture</span></h2>
//             </div>
//           </RevealOnScroll>
//           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
//             {technicalWorkflow.map((s, i) => (
...
//               <h2 className="font-heading text-4xl lg:text-5xl font-black text-white mb-6 leading-[1.1] tracking-tight">System Tracking <span className="text-gradient-gold">FAQs</span></h2>
//               <p className="text-zinc-400 text-[0.95rem] leading-relaxed mb-10 max-w-md">Learn how our indexing crawlers log data points securely without causing server loads.</p>
...
<section className="py-10 px-4 bg-zinc-50 border-b border-zinc-200 overflow-hidden">
  <div className="max-w-7xl mx-auto">
    <p className="text-center text-[0.65rem] text-zinc-400 uppercase tracking-[0.2em] font-bold mb-6">
      As Featured In
    </p>
  </div>
  ...
  <div className="group relative overflow-hidden">
    ...
    >
      {[...publishers, ...publishers].map((pub, i) => (
        ...
        >
          <span className="text-zinc-500 text-lg font-bold uppercase tracking-wide opacity-60 hover:opacity-100 hover:text-zinc-800 transition-all duration-300 whitespace-nowrap">
            {pub}
          </span>
        </div>
      ))}
