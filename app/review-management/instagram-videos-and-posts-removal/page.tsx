          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-start">
            <RevealOnScroll>
              <div className="sticky top-24 lg:col-span-2">
                ...
                <h2 className="font-heading text-3xl lg:text-4xl font-bold text-zinc-900 mb-6 leading-tight">Instagram Removal <span className="heading-script text-brand-blue">FAQs</span></h2>
                <p className="text-zinc-500 text-[0.95rem] leading-relaxed mb-8">Have a specific Instagram situation? Our experts offer a free confidential assessment with no obligation.</p>
