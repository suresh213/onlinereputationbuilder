...
const heroBullets = [
  ...
  "Loved by more than 250+ healthcare brands",
];

const faqs = [
  {
    q: "Why is reputation management important for healthcares?",
    a: "Reputation management helps your healthcare maintain a positive public image, attract more customers, build trust, and improve customer retention and revenue.",
  },
  {
  ...
  },
  {
    ...
    a: "We monitor Google, Yelp, TripAdvisor, Facebook, food discovery platforms, local listings, and other niche sites relevant to your healthcare category.",
  },
  {
    q: "How can social media affect my healthcare's reputation?",
  ...
  {
    q: "What if my healthcare has a crisis situation?",
    a: "Our crisis management team acts swiftly to mitigate damage, address concerns transparently, and restore your healthcare's reputation through strategic communication.",
  },
  {
    q: "Is reputation management only for large healthcares?",
    a: "No. A positive reputation is essential for healthcares of every size, from independent cafes and cloud kitchens to multi-location chains.",
  },
  {
    q: "How can I get started with Online Reputation Builder?",
    a: "Contact us through the consultation form and our experts will tailor a reputation management plan to your healthcare's unique needs.",
  },
];
...
const services = [
  ...
  {
    label: "Local SEO",
    title: "healthcare Listing Optimization",
  ...
  },
  {
    ...
    desc: "We encourage satisfied customers to leave reviews and promote your healthcare's strengths across the platforms that influence industry decisions.",
    icon: (
...
const impacts = [
  {
    ...
    desc: "Positive reviews and ratings encourage new customers to choose your healthcare over competitors.",
    icon: "🚶‍♂️",
  },
  {
    label: "Revenue",
  ...
  },
  {
    ...
    desc: "A well-managed reputation helps customers see your healthcare as a trusted, high-quality choice.",
    icon: "🌟",
  },
  {
    label: "Retention",
...
const processes = [
  ...
  {
    label: "Strategy",
    title: "Create a Tailored healthcare Plan",
    desc: "Each healthcare has unique needs. We build strategies that align with your brand, location, cuisine, customer profile, and growth goals.",
  },
  {
    label: "Engage",
        ...
        <div className="max-w-7xl mx-auto px-4 py-16 lg:py-24 grid grid-cols-1 lg:grid-cols-[1.15fr_0.85fr] gap-12 lg:gap-16 items-center relative z-10">
          <div className="hero-copy mt-4">
            ...
            <p className="text-white/70 text-base lg:text-lg mb-4 leading-relaxed max-w-2xl">
              In the competitive culinary world, a strong reputation is your most valuable ingredient. Online Reputation Builder ensures your healthcare stands out with glowing reviews, satisfied customers, and a trustworthy online presence.
            </p>
            <p className="text-zinc-400 text-sm mb-8 leading-relaxed max-w-2xl">
              We help healthcares protect ratings, manage customer feedback, improve local visibility, and build a loyal community of patrons who advocate for the brand.
            </p>
            ...
            <RevealOnScroll>
              <div className="premium-copy-panel pr-0 lg:pr-8">
                ...
                <p className="text-zinc-600 leading-relaxed mb-8 text-[0.95rem]">
                  Happy customers are your best marketers. Reputation management helps ensure clients leave satisfied, feedback is addressed promptly, and your healthcare's image remains impeccable. It is not just damage control; it is about building lasting relationships and turning clients into loyal advocates.
                </p>
              ...
              <div className="relative w-full max-w-lg mx-auto lg:ml-auto">
                ...
                <div className="premium-image-frame rounded-3xl overflow-hidden shadow-2xl border border-zinc-200/50 relative z-10">
                  <img
                    ...
                    alt="healthcare reputation management services"
                ...
                <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 w-[90%] z-20 glass-panel-light p-3 rounded-2xl border border-white shadow-xl hidden md:block">
                  <div className="grid grid-cols-3 gap-2 divide-x divide-zinc-200/60">
                    <div className="text-center px-2">
                      ...
                      <p className="text-[0.55rem] text-zinc-500 font-bold uppercase tracking-widest">Healthcare Brands</p>
                    </div>
                    <div className="text-center px-2">
          ...
          <RevealOnScroll>
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <h2 className="font-heading text-3xl lg:text-4xl font-bold text-zinc-900 tracking-tight leading-tight">
                Comprehensive healthcare Reputation <span className="heading-script text-brand-gold">Management Services</span>
              </h2>
              <p className="text-zinc-500 text-[0.95rem] mt-5 max-w-xl mx-auto leading-relaxed">
                We provide a full spectrum of services designed to boost your healthcare's reputation and attract more customers.
              </p>
            </div>
          </RevealOnScroll>
          ...
          <RevealOnScroll>
            <div className="text-center mb-16">
              ...
              <h2 className="font-heading text-3xl lg:text-4xl font-bold text-white mb-5 tracking-tight">
                How Healthcare Reputation Management Impacts <span className="text-gradient-gold">Your Bottom Line</span>
              </h2>
          ...
          <RevealOnScroll>
            <div className="text-center mb-16">
              ...
              <p className="text-zinc-500 text-[0.95rem] leading-relaxed max-w-2xl mx-auto">
                We simplify and amplify your healthcare's online presence with proven strategies, fast response systems, and expert reputation support.
              </p>
            </div>
          </RevealOnScroll>
            ...
            <RevealOnScroll>
              <div className="sticky top-24">
                ...
                <h2 className="font-heading text-3xl lg:text-4xl font-bold text-zinc-900 mb-6 leading-tight">
                  Healthcare Reputation Management <span className="heading-script text-brand-blue">FAQs</span>
                </h2>
          ...
          <RevealOnScroll>
            <div className="premium-copy-panel-dark">
              ...
              <p className="text-zinc-400 leading-relaxed mb-10 text-[0.95rem] max-w-lg">
                Schedule a free consultation today. Our healthcare reputation experts will assess your brand&apos;s
