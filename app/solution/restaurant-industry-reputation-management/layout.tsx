...
export const metadata: Metadata = {
  ...
  keywords: ["restaurant review management", "cafe ORM solutions", "google maps restaurant ratings", "delete fake food reviews", "online reputation management company in kolkata", "orm company in india", "orm services india"],
  alternates: {
