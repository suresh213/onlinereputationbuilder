...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Best ORM Agency in India | Top Online Reputation Management Company",
    description:
      "Protect & enhance your online reputation with India's Top ORM agency. Trusted by 1200+ clients across the globe.",
    url: siteUrl,
    type: "website",
    locale: "en_IN",
