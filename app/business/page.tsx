...
const negativeExamples = [
  ...
  "Your business + bad customer service",
  "Fake reviews saying your product is bad",
];

const allServices = [
  {
    category: "Business",
    title: "Remove Bad Google Links",
    desc: "Delete negative news and fake articles from Google search to protect your good name.",
    icon: (
  ...
  },
  {
    ...
    desc: "Build a strong and positive image so customers trust you when they search your name.",
    icon: (
  ...
  },
  {
    ...
    desc: "Fast help when your business is facing sudden bad news, viral videos, or social media attacks.",
    icon: (
  ...
  },
  {
    ...
    desc: "Delete fake 1-star reviews and get more positive 5-star ratings from real customers.",
    icon: (
  ...
  },
  {
    ...
    desc: "We watch the internet 24/7 to catch any bad comments about you before they spread.",
    icon: (
  ...
  },
  {
    ...
    desc: "Create a very professional and strong online image for CEOs, doctors, and professionals.",
    icon: (
        ...
        <div className="max-w-7xl mx-auto px-4 py-16 lg:py-24 grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:gap-16 items-center relative z-10">
          <div className="hero-copy mt-4">
            <RevealOnScroll>
              ...
              <h1 className="font-heading text-4xl sm:text-5xl lg:text-[3.5rem] font-black text-white leading-[1.08] mb-6 tracking-tight">
                Are bad links or fake reviews <span className="text-gradient-gold">hurting your business?</span>
              </h1>

              <p className="text-white/70 text-base lg:text-lg mb-6 leading-relaxed max-w-2xl">
                When people search for your business on Google, do they see things like this?
              </p>
              ...
              <p className="text-white/70 text-sm mb-10 leading-relaxed max-w-2xl border-l-2 border-brand-gold pl-4">
                If you have bad links on the first page of Google, do not worry. We have the right tools and legal methods to remove those links or push them very far down so no one sees them.
              </p>
          ...
          <div className="relative lg:mt-6">
            <RevealOnScroll delay={200}>
              ...
              <div className="relative glass-panel bg-zinc-950/80 backdrop-blur-md border border-zinc-700/50 rounded-3xl p-6 lg:p-7 shadow-2xl">
          ...
          <RevealOnScroll>
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <h2 className="font-heading text-3xl lg:text-4xl font-bold text-zinc-900 leading-tight">
                Best Solutions for <span className="heading-script text-brand-blue">Indian Businesses</span>
              </h2>
              <p className="text-zinc-500 text-[0.95rem] mt-5 leading-relaxed">
                We offer complete services to fix, protect, and grow your online image. See how we can help your business or personal brand today.
              </p>
            </div>
          </RevealOnScroll>
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <RevealOnScroll>
            <div className="text-center mb-12">
              ...
              <h2 className="font-heading text-3xl lg:text-4xl font-bold text-white tracking-tight">Real Results for <span className="heading-script text-brand-gold">Real Clients</span></h2>
              <p className="text-zinc-400 text-[0.95rem] mt-4 leading-relaxed">We care about your success. We do honest work and deliver what we promise. Read what our happy clients say.</p>
            </div>
          </RevealOnScroll>
          ...
          <RevealOnScroll>
            <div className="premium-copy-panel-dark">
              ...
              <h2 className="font-heading text-3xl lg:text-[2.75rem] font-bold text-white mb-6 leading-tight tracking-tight">
                Do not let one bad Google link <span className="heading-script text-blue-400">destroy your sales</span>
              </h2>
              <p className="text-zinc-400 leading-relaxed mb-10 text-[0.95rem] max-w-lg">
                Call us today for a free chat. We will look at your problem and give you a clear plan to fix it, completely free of charge.
              </p>
