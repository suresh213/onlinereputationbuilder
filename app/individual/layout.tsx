...
export const metadata: Metadata = {
  ...
  keywords: ["personal reputation management", "reputation repair for individuals", "clean personal google search", "delete mugshots google", "private link removal", "personal branding agency", "best reputation management"],
  alternates: {
