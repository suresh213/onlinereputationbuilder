...
export const metadata: Metadata = {
  ...
  keywords: ["PR services India", "media relations agency Kolkata", "distribute press release", "news publication marketing", "press release service", "pr reputation management", "brand marketing strategy", "brand strategy and marketing"],
  alternates: {
